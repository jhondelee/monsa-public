                                             ...
                                             <?php $__currentLoopData = $items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-center">
                                                        <div class="btn-group">
                                                           <a class="btn-primary btn btn-xs btn-add-items" onclick="clickToAdditem('<?php echo e($item->id); ?>'); return false;"><i class="fa fa-plus"></i></a>
                                                        </div>
                                                    </td>
...
<script type="text/javascript">
    ...
    var id = $('#supplier_id').val();
        ...
        $('#dTable-components-item-table tbody').empty();
                ...
                $.ajax({
                        url:  '<?php echo e(url('supplier/showitems')); ?>',
                        type: 'POST',
                        dataType: 'json',
     ...
     function clickToAdditem(data) {
            ...
            var id = data;
                ...
                $.ajax({
                        url:  '<?php echo e(url('supplier/supplied')); ?>',
                        type: 'POST',
                        dataType: 'json',
                        data: { _token: "<?php echo e(csrf_token()); ?>",
                        id: id}, 
...
<?php $__env->stopSection(); ?><?php /**PATH C:\laravel\public_html\resources\views/pages/item_management/suppliers/additem.blade.php ENDPATH**/ ?>