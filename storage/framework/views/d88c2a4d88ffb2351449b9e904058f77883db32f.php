                ...
                <div class="col-lg-12">
                    <div class="ibox float-e-margins">
                        ...
                        <div class="ibox-content">
                             ...
                             <?php if(!can('incoming.post')): ?>

                                <?php if($incomings->status == 'RECEIVING'): ?>

                                    <div class="btn-group">
                                         <button type="button" class="btn btn-success" onclick="confirmPost('<?php echo e($incomings->id); ?>'); return false;" id="post-btn"><i class="fa fa-check">&nbsp;</i>Post&nbsp; </button>
                                    </div>
                            ...
                            <a href="<?php echo e(route('incoming.print',$incomings->id)); ?>" class="btn btn-primary btn-print"><i class="fa fa-print">&nbsp;</i>Print</a> 

                     
                            
                            <div class="form-horizontal m-t-md">

                            <?php echo Form::model($incomings, ['route' => ['incoming.update', $incomings->id]]); ?>


                                <?php echo $__env->make('pages.purchase_order.incoming._form', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laravel\public_html\resources\views/pages/purchase_order/incoming/edit.blade.php ENDPATH**/ ?>