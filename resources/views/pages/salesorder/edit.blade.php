                ...
                <div class="col-lg-12">
                    <div class="ibox float-e-margins">
                        ...
                        <div class="ibox-content">
                            ...
                            @endif
                                     <a href="{{route('salesorder.print',$order->id)}}" class="btn btn-primary btn-print"><i class="fa fa-print">&nbsp;</i>Print</a> 

                            <div class="form-horizontal m-t-md">
                 
                           
                            {!! Form::model($order, ['route' => ['salesorder.update', $order->id],'id'=>'orders_form']) !!}
                                   
                                @include('pages.salesorder.orders._form_add')
...
<script type="text/javascript">
        ...
        $(function() {
            $.ajax({
                url:  '{{ url('salesorder/orderToSupplier') }}',
                type: 'POST',
                dataType: 'json',
